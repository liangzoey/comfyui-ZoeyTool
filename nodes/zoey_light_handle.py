...
class ZoeyLightHandle:
    ...
    _LIGHT_TYPE_DESC = {
        "摄影棚灯光": "模仿摄影棚柔和均匀的棚拍布光",
        "丁达尔光": "模仿光线在空气中穿透形成可见光柱，带有朦胧散射效果",
        "光斑": "模仿光线透过缝隙形成斑驳的光点效果",
        "束光": "模仿光线收束成集中的光束，方向感强烈",
        "栅栏光": "模仿光线透过百叶窗或格栅形成明暗相间的条状光影，带有规则几何纹理",
        "散射光": "模仿光线经过漫射变得柔和均匀，阴影柔和",
        "柔光": "模仿光线经过柔化处理，阴影边缘模糊过渡自然",
        "硬光": "模仿光线直接照射，明暗对比强烈，阴影边缘锐利",
        "点光": "模仿从点状光源发出呈放射状扩散，有明显光源感",
        "面光": "模仿从大面积发光面发出，光线均匀柔和",
        "条光": "模仿光线呈条带状分布，有方向性的线性照明",
        "光晕": "模仿光线在边缘扩散形成柔和的辉光发光效果",
        "漏光": "模仿光线从缝隙或边缘渗入形成不规则光带",
        "轮廓光": "模仿从侧后方勾勒主体边缘的照明光线",
        "斑驳光": "模仿光线穿过遮挡物形成明暗交错的光影效果",
        "逆光": "模仿光线从主体背后照射形成剪影效果",
    }
